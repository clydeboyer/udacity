...
Americans are notoriously bad at geography. To help us improve our basic understanding of Europe, memorize and name the capitals of the following European cities. ___1___ is the capital of the Emerald Isle, Ireland. Kelly Pickler infamously missed this next question on a U.S game show: The capital of France is ___2___ , otherwise known as la Ville des Lumieres. ___3___ is the capital of the Netherlands. ___4___ is the capital of Spain. The following country and capital have the same name. To help you out a bit, this country is known for Grand Prix, casinos and Princess Grace Kelly. ___5___ is the capital of ___5___.
...
You chose the MEDIUM Quiz. Time to break a little sweat. You will get 5 guesses per problem. Let's get started.
...
You chose the ZOIKS Quiz. You will get 5 guesses per problem. Let's get started.
...
def quiz_game(quiz, answers, attempts):
    ...
    while index < len(answers):
        ...
        user_input = raw_input("Please provide the correct response for " + str(blanks[index]) + "\n")
        if user_input == answers[index]:
            ...
            if attempts == 1:
                return "\nGame Over! Keep studying and better luck next time."
            else:
                attempts = int(attempts) - 1
                print "\nDoh! Missed! But, don't give up hope. You still have " + str(attempts) + " remaining attempts. \n"
